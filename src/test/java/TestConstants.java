...
public class TestConstants {
    ...
    private static final String[]     ACTUAL_DEFENDERS                =
            {"Marcos Rojo", "Harry Maguire", "Victor Nilsson-Lindelöf", "Axel Tuanzebe", "Chris Smalling", "Phil Jones", "Luke Shaw", "Eric Bailly", "Timothy Fosu-Mensah", "Aaron Wan-Bissaka",
                    "Diogo Dalot", "Brandon Williams",
                    "Teden Mengi"};
    private static final String[]     GOALKEEPERS                     = {"David De Gea", "Sergio Romero", "Nathan Bishop", "Dean Henderson", "Joel Pereira", "Lee Grant"};
    private static final String[]     EXPECTED_MIDFIELDERS            =
            {"Fred", "Bruno Fernandes", "Jesse Lingard", "Paul Pogba", "Nemanja Matić", "Donny van de Beek", "Scott McTominay", "Juan Mata", "Daniel James", "Andreas Pereira", "Tahith Chong",
                    "James Garner"};
    ...
    private static final List<String> EXPECTED_COMPETITIONS_LIST      = Stream.of(
            "WC Qualification", "Primera B Nacional", "Superliga Argentina", "Supercopa Argentina", "WC Qualification", "A League", "FFA Cup", "Erste Liga", "Bundesliga", "ÖFB Cup", "Playoffs 1/2",
            "Coupe de Belgique", "Division 1B", "Jupiler Pro League", "Supercoupe de Belgique", "Playoffs II", "LFPB", "Premier Liga", "Copa do Brasil", "Série D", "Série C", "Série B", "Série A",
            "Kupa na Bulgarija", "A PFG", "Canadian Championship", "Primera División", "Playoffs 1/2", "Supercopa de Chile", "Chinese Super League", "Liga Postobón", "Superliga de Colombia",
            "Prva Liga", "Synot Liga", "DBU Pokalen", "Superliga", "Play Offs 1/2", "Copa Pilsener Serie A", "Football League Cup", "FA Community Shield", "FA Cup", "National League", "League Two",
            "League One", "Championship", "Premier League", "Meistriliiga", "UEFA Europa League", "UEFA Champions League", "European Championship", "UEFA Women's EURO", "WC Qualification",
            "Suomen Cup", "Veikkausliiga", "Coupe de la Ligue", "Ligue 2", "Ligue 1", "Coupe de France", "Playoffs 1/2", "Trophée des Champions", "Playoffs 2/3", "DFB-Pokal", "Regionalliga",
            "3. Liga", "2. Bundesliga", "Bundesliga", "DFL Super Cup", "Frauen Bundesliga", "Greek Cup", "Super League", "Magyar Kupa", "NB I", "Úrvalsdeild", "I-League", "Ligat ha'Al", "Supercoppa",
            "Coppa Italia", "Serie C", "Serie B", "Serie A", "J.League Cup", "J. League Division 2", "J. League", "Super Cup", "Virslīga", "A Lyga", "Premier League", "Copa MX", "SuperCopa MX",
            "Liga MX", "KNVB Beker", "Jupiler League", "Eredivisie", "Johan Cruijff Schaal", "League Cup", "Premiership", "Tippeligaen", "1. divisjon", "Playoffs 1/2", "WC Qualification",
